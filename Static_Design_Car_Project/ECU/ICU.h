...
/*				               Constants                                */
/************************************************************************/
#define ICU_CH0			(0)			/* defines External Interrupt 0 */    /*(not implemented yet)*/                   
#define ICU_CH1			(1)       	/* defines External Interrupt 1 */    /*(not implemented yet) */                  
...
#define ICU_RISE_TO_RISE		(0)         /*(not implemented yet) */
#define ICU_RISE_TO_FALL		(1)
#define ICU_FALE_TO_RISE		(2)             /*(not implemented yet) */
